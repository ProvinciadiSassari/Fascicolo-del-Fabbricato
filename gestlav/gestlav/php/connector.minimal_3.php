...
if ($_SESSION['idlevel']==7) {
	...
	'roots' => array(
		...
		array(
			...
			'path'          => $_SESSION['cartella'],                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/'.$_SESSION['cartella'], // URL to files (REQUIRED)
			...
			'accessControl' => 'access',                     // disable and hide dot starting files (OPTIONAL)
                        'disabled' => array('extract', 'archive', 'mkdir','rm')
//                        'attributes' => array(
//                                                array(
...
//                                        )
		...
		array(
			...
			'driver'        => 'Trash',
			'path'          => '../files/.trash3/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../files/.trash3/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
