...
$(document).ready(function() {                
      ...
      $('#tab_corrispondenza_en').DataTable({
        responsive: true,
        "aaSorting": [[ 0, "asc" ]],
        "bDestroy": true,
        "language": {
...
<table class="table table-striped table-bordered" width="100%" cellspacing="0" id="tab_corrispondenza_en">
	...
	<?php
        $query = "SELECT
                    ...
                    Destinatario
                FROM corrispondenza                   
                WHERE IDLavoro=$id_lavoro AND Tipo=1";
	...
	while ($row = mysql_fetch_assoc($result)){
		...
		echo "<td align='center'>".$DataProt_Interno."</td>";  
                ...
                echo "<td>".utf8_encode($Destinatario)."</td>";
                 echo "<td align='center'><img src='images/document.png' class='hand' id='img_mod_corrispondenza_in' style='width:24px;' alt='".$IDCorrispondenza."'/></td>"; 
		echo "</tr>";              
	}
        ?>
	</tbody>    
